...
import com.shinlee.common.composable.bottomsheet_content.ReportBottomSheetContent
...
class ReportBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.report_bottonsheet, container, false)
    }
    ...
    fun showByTag(manager: FragmentManager) {
        super.show(manager, ReportBottomSheet::class.java.name)
    }
