...
//
//// Print the list of Video objects
//    videoList.forEach { println(it) }
...
//    ) {
//        VerticalPager(state = pagerState, flingBehavior = fling, beyondViewportPageCount = 0) { page ->
//            VerticalVideoPage(
//                modifier = Modifier.fillMaxSize(),
//                videoUri = videoList[page].videoLink,
//                pagerState = pagerState, pageIndex = page
//            )
//
////            VideoPlayer(
////                videoUri = videoList[page], // Replace with your video URL
////                modifier = Modifier.fillMaxSize(),
////                thumbnailUrl = "",
